...
export default function Header() {
  return (
   <>
   <header className=' bg-slate-300 w-full  h-full flex items-center shadow-lg'>
    <Link href="/"> <h1 className=' ml-4 text-indigo-600 font-extrabold text-3xl p-1  leading-none tracking-normal'>Invest</h1></Link>
